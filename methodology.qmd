...
The tool ogr2ogr imported the data and adjusted the multilinestring geometry to linestring geometry to process single features more efficiently as recommended @obe_pgrouting_2017.
...
### Geometry: OpenStreetMap network (OSM)
...
### Graph: OpenRouteService network (ORS)
...
sync(m1,m2) 
```
##### Inspection of ORS graph network
