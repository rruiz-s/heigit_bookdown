...
centrality_post_local <- st_read(eisenberg_connection, query = "SELECT * FROM heigit.centrality_weighted_100_bidirect_cleaned_post")
centrality_pre_local <- st_read(eisenberg_connection, query ="SELECT * FROM heigit.centrality_weighted_100_bidirect_cleaned")
